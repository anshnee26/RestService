 ...
 * 
 * static { user.add(new User(1, "Anshu", new Date())); user.add(new User(2,
 * "Rutu", new Date())); user.add(new User(3, "Monu", new Date()));
 * 
 * }
 * 
 ...
 * 
 * for (User users: user) { if(users.getId()==id) { return users; }
 * 
 * }
 * 
 * return null; }
 ...
 * 
 * 
 * if (usering.getId()==null) { usering.setId(++count); }
 * 
 * user.add(usering);
 * 
 * return usering; }
 ...
 * 
 * if(user.getId()==id) { iterator.remove(); return user; } }
 * 
 * return null;
 * 
 * }
