 ...
 * 
 * @RestController public class UserJPAResource {
 * 
 ...
 * //retrieve All users
 * 
 * @GetMapping("/jpa/AllUsers") public List<User> retrieveAllUser(){
 * 
 ...
 * 
 * if(!check.isPresent()) { throw new UserNotFoundException("id- "+id); } return
 * check.get();
 * 
 * 
 * }
 ...
 * //Add USer
 * 
 * @PostMapping("/jpa/addUser") public ResponseEntity<Object>
 * addUser(@RequestBody User postUser) {
 * 
