 ...
 * //retrieve All users
 * 
 * @GetMapping("/AllUsers") public List<User> retrieveAllUser(){
 * 
 ...
 * 
 * if(check==null) { throw new UserNotFoundException("id- "+id); } return check;
 * 
 * 
 * }
 * 
 ...
 * 
 * if(check==null) { throw new UserNotFoundException("id- "+id); }
 * 
 * 
 * 
 * }
