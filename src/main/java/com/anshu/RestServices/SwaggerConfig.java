 ...
 * 
 * 
 * //telling this is a configuration class
 * 
 * @Configuration
 * 
 * //Enabling swagger
 ...
 * Contact("Anshu Ranjan","https://anshuSpring.com", "ranjan.anshuk@gmail.com");
 * 
 * public static final ApiInfo DEFAULT_API_INFO = new
 * ApiInfo("Awesome API TItle", "Awesome API Description", "1.0","urn:tos",
